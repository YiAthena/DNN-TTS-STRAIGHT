...
%    save([file_target filesep 'output_std'],'output_std');
     input_mean=importdata([mean_dir filesep 'input_average_mean.mat']);
     input_std=importdata([mean_dir filesep 'input_average_std.mat']);
     output_mean=importdata([mean_dir filesep 'output_average_mean.mat']);
     output_std=importdata([mean_dir filesep 'output_average_std.mat']);
