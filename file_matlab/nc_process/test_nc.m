function test_nc(file_input,file_target,nc_filename,mean_input_dir,mean_output_dir);
...
for n=1:len_input_files
        ...
        disp(str)
%      data_input1=importdata([file_input filesep basename '.input']);
%		data_input=dlmread([file_input filesep basename '.input']);
...
%    save([file_target filesep 'output_std'],'output_std');
    % input_mean=importdata([mean_dir filesep 'aver_output_mean']);
    %  input_std=importdata([mean_dir filesep 'aver_output_std']);
    %  output_mean=importdata([mean_dir filesep 'aver_output_mean']);
    %  output_std=importdata([mean_dir filesep 'aver_output_std']);
    ...
    netcdf.endDef(ncid );
   input_mean=importdata([mean_input_dir filesep 'input_mean.mat']);
   input_std=importdata([mean_input_dir filesep 'input_std.mat']);
   output_mean=importdata([mean_output_dir filesep 'output_mean.mat']);
   output_std=importdata([mean_output_dir filesep 'output_std.mat']);
    frameIndex = 0;
    fileIndex = 0;
for n=1 : len_input_files
